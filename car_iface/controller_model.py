...
class Car_Interface():
    ...
    def __init__(self, model = "simple"):
        ...
        self.rolling_bias = 0.009967640511024937
        self.friction_constant = 0.10957477037138734
        self.accelerator_weight = 0.09999426536315299
        self.brake_weight = -0.24992635302029031
    ...
    def apply_control(self, pedal, amount):
        ...
        self.position += self.dt*self.velocity + 0.5*self.accel*(self.dt**2)
